...
ChainFusion is a decentralized bridge that allows fast, cheap and secure cross-chain communication, for example sending assets between blockchains. We strongly believe that bridges should be decentralized and trustless, everyone should be able to become a validator and secure the bridge.
